...
class TestNameRange:
    def test_plain_min_max(self):
        assert name_range(["Lecture 2", "Lecture 5", "Lecture 9"]) == {"start": "2", "end": "9"}
    ...
    def test_non_contiguous_is_plain_min_max(self):
        ...
        assert name_range(["Lecture 3", "Lecture 7", "Lecture 2"]) == {"start": "2", "end": "7"}
    ...
    def test_mixed_depth_2_vs_2_2(self):
        ...
        assert name_range(["Lecture 2.2", "Lecture 2", "Lecture 3"]) == {"start": "2", "end": "3"}

    def test_empty_is_none(self):
        assert name_range([]) is None

    def test_names_without_number_dropped(self):
        assert name_range(["Intro", "Lecture 5", "Overview"]) == {"start": "5", "end": "5"}
