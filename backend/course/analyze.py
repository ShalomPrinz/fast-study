...
the phase worker the runner drives — read {slug}.txt, analyze, write {slug}-analyzed.md. A
...
def run_analyze(course: str, extractor: Extractor) -> dict:
    """Analyze one extractor's snippet report; write {slug}-analyzed.md. Returns a status dict
