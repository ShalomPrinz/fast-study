...
- When your changes make `downloader/CLAUDE.md`, a sub-package's `CLAUDE.md` or `docs/`, or `downloader/README.md` (end-user install guide) outdated, update them in the same pass. Keep docs concise; one short line is the default.
