...
- Ensure the root/main `CLAUDE.md` states this rule, generalized to all services and softened.
- Emphasize it specifically in this service's `CLAUDE.md`.

## Step 3 — Thin the code comments

Reduce comments in the service's code to concise one-liners (two lines max), each specific and earning its place. The full logic lives in the docs (Step 1), not inline. Remove comments that just restate the code.
